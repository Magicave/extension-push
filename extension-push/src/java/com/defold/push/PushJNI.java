...
public class PushJNI implements IPushListener {
    ...
    @Override
    public native void addPendingNotifications(int uid, String title, String message, String payload, long timestamp, int priority, String channelId, String channelName, String channelDescription);
}
