...
public interface IPushListener {
    ...
    public void addPendingNotifications(int uid, String title, String message, String payload, long timestamp, int priority, String channelId, String channelName, String channelDescription);
}
